...
Computes a post-processed data structure across a set of simulations with varying parameters (e.g. mass, CMF, etc.), by combining outputs from multiple structural, thermal, buoyancy, and magnetic evolution models.

Returns a .pkl file (sweep.pkl) containing a class with attributes describing planet evolution (e.g. radii, temperatures, heat flows, mass anomaly fluxes, rates of entropy production, magnetic Reynolds numbers, magnetic field intensities, etc.) as a function of the sweep parameter.

Files contained in the subfolder "Data" have been generated by running a simplified version of this script on a relevant set of models.
